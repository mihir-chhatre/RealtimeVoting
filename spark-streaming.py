...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             ...
             .config("spark.jars", "/Users/mihirchhatre/Documents/Projects/RealtimeVoting/postgresql-42.7.1.jar")  # PostgreSQL driver
             .config("spark.sql.adaptive.enabled", "false")  # Disable adaptive query execution
             .getOrCreate())
    
    # Schema needed to deserialize JSON from Kafka topic
    ...
    # update mode is used because we are aggregating the data
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        .writeStream \
        .format("kafka") \
        .option("kafka.bootstrap.servers", "localhost:9092") \
        .option("topic", "aggregated_votes_per_candidate") \
        .option("checkpointLocation", "/Users/mihirchhatre/Documents/Projects/RealtimeVoting/checkpoints/checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/Users/mihirchhatre/Documents/Projects/RealtimeVoting/checkpoints/checkpoint2") \
        .outputMode("update") \
        .start()
